...
namespace mint
{
    namespace Language
    {
        ...
        public:
            const mint::Tree<SyntaxTreeItem>&                 getSyntaxTree() const noexcept;
        ...
        protected:
            mint::TreeNodeAccessor<SyntaxTreeItem>            getSyntaxTreeRootNode() noexcept;
...
#include <MintRenderingBase/Include/Language/IParser.inl>
