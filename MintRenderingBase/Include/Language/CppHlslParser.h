...
#include <MintRenderingBase/Include/Language/LanguageCommon.h>
...
namespace mint
{
    namespace Language
    {
        ...
        MINT_INLINE static constexpr const char* const getCppHlslDefinition(const CppHlslDefinitionEnum cppHlslDefinitionEnum)
        {
            return kCppHlslDefinitionArray[static_cast<uint32>(cppHlslDefinitionEnum)];
        }
        MINT_INLINE static const bool isCppHlslDefinition(const CppHlslDefinitionEnum cppHlslDefinitionEnum, const std::string& cmpString)
        {
        ...
        private:
            ...
            uint32                                  _byteOffset;
            mint::Vector<CppHlslTypeInfo>             _memberArray;    // Member variables
        };
        ...
        private:
            mint::Vector<CppHlslTypeTableItem>            _typeTable;
            mint::HashMap<std::string, uint32>            _typeTableUmap;

            mint::HashMap<std::string, uint32>            _typeAliasTableUmap;
            
        private:
            mint::Vector<CppHlslTypeInfo>                 _typeInfoArray;
            mint::HashMap<std::string, uint32>            _typeInfoUmap;
...
#include <MintRenderingBase/Include/Language/CppHlslParser.inl>
