...
namespace mint
{
    ...
    namespace RenderingBase
    {
        ...
        private:
            ...
            void                        pushInputElement(DxInputElementSet& inputElementSet, const mint::CppHlsl::TypeMetaData& outerDataTypeMetaData, const mint::CppHlsl::TypeMetaData& memberTypeMetaData);
