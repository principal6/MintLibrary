...
namespace mint
{
    namespace Language
    {
            ...
            : ILexer()
        {
            ...
            registerGrouper('(', mint::Language::GrouperClassifier::Open);
            registerGrouper('{', mint::Language::GrouperClassifier::Open);
            registerGrouper('[', mint::Language::GrouperClassifier::Open);
            registerGrouper(')', mint::Language::GrouperClassifier::Close);
            registerGrouper('}', mint::Language::GrouperClassifier::Close);
            registerGrouper(']', mint::Language::GrouperClassifier::Close);
            ...
            registerOperator("=", mint::Language::OperatorClassifier::AssignmentOperator);
            registerOperator("+=", mint::Language::OperatorClassifier::AssignmentOperator);
            registerOperator("-=", mint::Language::OperatorClassifier::AssignmentOperator);
            registerOperator("*=", mint::Language::OperatorClassifier::AssignmentOperator);
            registerOperator("/=", mint::Language::OperatorClassifier::AssignmentOperator);
            ...
            registerOperator("<", mint::Language::OperatorClassifier::RelationalOperator);
            registerOperator("<=", mint::Language::OperatorClassifier::RelationalOperator);
            registerOperator(">", mint::Language::OperatorClassifier::RelationalOperator);
            registerOperator(">=", mint::Language::OperatorClassifier::RelationalOperator);
            registerOperator("==", mint::Language::OperatorClassifier::RelationalOperator);
            ...
            registerOperator("+", mint::Language::OperatorClassifier::ArithmeticOperator);
            registerOperator("-", mint::Language::OperatorClassifier::ArithmeticOperator);
            registerOperator("++", mint::Language::OperatorClassifier::ArithmeticOperator);
            registerOperator("--", mint::Language::OperatorClassifier::ArithmeticOperator);
            registerOperator("*", mint::Language::OperatorClassifier::ArithmeticOperator);
            ...
            registerOperator("&&", mint::Language::OperatorClassifier::LogicalOperator);
            registerOperator("||", mint::Language::OperatorClassifier::LogicalOperator);
            registerOperator("!", mint::Language::OperatorClassifier::LogicalOperator);

            registerOperator("&", mint::Language::OperatorClassifier::BitwiseOperator);
            registerOperator("|", mint::Language::OperatorClassifier::BitwiseOperator);
            registerOperator("^", mint::Language::OperatorClassifier::BitwiseOperator);
            registerOperator("~", mint::Language::OperatorClassifier::BitwiseOperator);

            registerOperator(".", mint::Language::OperatorClassifier::MemberAccessOperator);

            registerOperator("?", mint::Language::OperatorClassifier::OperatorCandiate);
            registerOperator(":", mint::Language::OperatorClassifier::OperatorCandiate);
