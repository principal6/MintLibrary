...
:### COMPILE
cl MintCommon\Source\Logger.cpp /c /Fo_intermediate\MintCommon\ /Fd_output\MintCommon.pdb
cl MintContainer\Source\UniqueString.cpp /c /Fo_intermediate\MintContainer\ /Fd_output\MintContainer.pdb
...
cl MintLibrary\Source\AllHeaders.cpp -c /Yc"stdafx.h" /Fo_intermediate\MintLibrary\ /Fd_output
lib _intermediate\MintLibrary\AllHeaders.obj /OUT:_output\MintLibrary.lib _output\MintCommon.lib _output\MintContainer.lib _output\MintMath.lib _output\MintPlatform.lib _output\MintRenderingBase.lib _output\MintRendering.lib _output\MintGame.lib
