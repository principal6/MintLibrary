...
set COMMON_COMP_OPTS="/I. /IExternals\freetype_2_10_4\include\ /IExternals\stb_image\ /std:c++20 /EHsc /D_UNICODE /DUNICODE /D_CONSOLE"
...
IF NOT EXIST _intermediate\MintApp mkdir _intermediate\MintApp
...
cl MintContainer\Source\_UnityBuild.cpp /c /Fo_intermediate\MintContainer\ /Fd_output\MintContainer.pdb
...
cl MintApp\Source\_UnityBuild.cpp /c /Fo_intermediate\MintApp\ /Fd_output\MintApp.pdb
cl MintGame\Source\_UnityBuild.cpp /c /Fo_intermediate\MintGame\ /Fd_output\MintGame.pdb


:### LINK
lib _intermediate\MintCommon\CommonDefinitions.obj /OUT:_output\MintCommon.lib
lib _intermediate\MintContainer\_UnityBuild.obj /OUT:_output\MintContainer.lib
...
lib _intermediate\MintApp\_UnityBuild.obj /OUT:_output\MintApp.lib
...
lib _intermediate\MintLibrary\_UnityBuild.obj /OUT:_output\MintLibrary.lib _output\MintCommon.lib _output\MintContainer.lib _output\MintMath.lib _output\MintPlatform.lib _output\MintReflection.lib _output\MintLanguage.lib _output\MintRenderingBase.lib _output\MintRendering.lib _output\MintAudio.lib _output\MintPhysics.lib _output\MintGUI.lib _output\MintApp.lib _output\MintGame.lib
