...
#pragma region Intersection Free Functions
		MINT_INLINE bool Intersect_Circle_Point(const Float2& circleCenter, const float circleRadius, const Float2& point)
		{
		...
		MINT_INLINE bool Intersect_AABB_Point(const Rect& aabb, const Float2& point)
		{
