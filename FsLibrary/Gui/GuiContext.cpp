	...
	namespace Gui
	{
		...
		void GuiContext::initialize(const char* const font)
		{
			if (_fontRendererBackground.loadFont(font) == false)
			{
				...
				_fontRendererBackground.pushGlyphRange(fs::SimpleRendering::GlyphRange(L'∞°', L'∆R'));
			...
			if (_fontRendererForeground.loadFont(font) == false)
			{
				...
				_fontRendererForeground.pushGlyphRange(fs::SimpleRendering::GlyphRange(L'∞°', L'∆R'));
		...
		{
			FS_ASSERT("±Ë¿Âø¯", _controlStackPerFrame.back()._controlType == ControlType::Button, "begin ∞˙ end ¿« ControlType ¿Ã ¥Ÿ∏®¥œ¥Ÿ!!!");
		...
		{
			FS_ASSERT("±Ë¿Âø¯", _controlStackPerFrame.back()._controlType == ControlType::Window, "begin ∞˙ end ¿« ControlType ¿Ã ¥Ÿ∏®¥œ¥Ÿ!!!");
			_controlStackPerFrame.pop_back();
		}
		...
		{
			FS_ASSERT("±Ë¿Âø¯", _controlStackPerFrame.back()._controlType == ControlType::TitleBar, "begin ∞˙ end ¿« ControlType ¿Ã ¥Ÿ∏®¥œ¥Ÿ!!!");
			_controlStackPerFrame.pop_back();
		}
		...
		{
			FS_ASSERT("±Ë¿Âø¯", _controlStackPerFrame.empty() == true, "begin ∞˙ end »£√‚ »Ωºˆ∞° ∏¬¡ˆ æ Ω¿¥œ¥Ÿ!!!");
