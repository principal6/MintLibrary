...
namespace fs
{
	...
	inline void Float4x4::setZero() noexcept
	{
		memset(_m, 0, sizeof(float) * 16);
	}

	inline void Float4x4::setIdentity() noexcept
	{
	...
	inline const float Float4x4::determinant() const noexcept
	{
